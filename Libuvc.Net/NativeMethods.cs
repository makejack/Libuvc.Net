...
namespace Libuvc.Net
{
    static class NativeMethods
    {
        ...
        [DllImport(libName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int uvc_get_ctrl(UvcDeviceHandle devh, byte unit, byte ctrl, IntPtr data, int len,
        ...
        [DllImport(libName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern UvcError uvc_get_ae_priority(UvcDeviceHandle devh, out byte priority,
            RequestCode req_code);
        ...
        [DllImport(libName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern UvcError
            uvc_get_exposure_rel(UvcDeviceHandle devh, out sbyte step, RequestCode req_code);
        ...
        [DllImport(libName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern Frame uvc_allocate_frame(uint dataBytes);

        [DllImport(libName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void uvc_free_frame(Frame frame);

        [DllImport(libName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern UvcError uvc_mjpeg2rgb(ref Frame inFrame, Frame outFrame);

        [DllImport(libName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern UvcError uvc_yuyv2rgb(ref Frame inFrame, Frame outFrame);

        [DllImport(libName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern UvcError uvc_yuyv2bgr(ref Frame inFrame, Frame outFrame);

        [DllImport(libName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern UvcError uvc_any2rgb(ref Frame inFrame, ref Frame outFrame);

        [DllImport(libName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern UvcError uvc_any2bgr(ref Frame inFrame, ref Frame outFrame);
    }
}